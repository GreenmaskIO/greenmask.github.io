...
<Tabs>
<TabItem value="the-validation-warning" label="The validation warning">
...
<TabItem value="schema-diff-events" label="Schema diff events">
...
<TabItem value="transformation-diff-line" label="Transformation diff line">
